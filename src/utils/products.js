...
import ficon from '../Images/ficon.jpg'; 
...
export const serviceData = [
  {
    icon: <img src={ficon} alt="Footprint Icon" style={{ width: '24px', height: '24px' }} />, // Add the footprint icon
    title: "Footprint Calculator",
    subtitle: (
      <div className="footprint-card">
        <p>Lets check how many carbon footprint our products on  website reduces</p> 
        <button onClick={() => window.location.href = '/src/components/footprintcai/fprint'}>
         Lets Check
        </button>
      </div>
    ),
...
export const discoutProducts = [
  ...
  {
    id: "13",
    productName: "Basic Utilities Kit",
    imgUrl: phone04,
    category: "mobile",
    price: 799,
    discount:5,
...
export const products = [
  ...
  {
    id: "11",
    productName: "Eco Friendly Loafer",
    imgUrl: phone02,
    category: "bath and body works",
    price: 799,
    shortDesc:
  ...
  {
    id: "12",
    productName: "Aurevedic Handmade Soap",
    imgUrl: phone03,
    category: "bath and body works",
    price: 599,
    shortDesc:
  ...
  {
    id: "14",
    productName: "Scented Body Shower Gel",
    imgUrl: phone05,
    category: "bath and body works",
    price: 899,
    shortDesc:
  ...
  {
    id: "15",
    productName: "Handmade Organic Soaps",
    imgUrl: phone06,
    category: "bath and body works",
    price: 699,
    shortDesc:
  ...
  {
    id: "20",
    productName: "Eco Friendly Containers",
    imgUrl: wireless01,
    category: "wireless",
    price: 199,
    shortDesc:
  ...
  {
    id: "23",
    productName: "Scented Body Wash kit",
    imgUrl: wireless04,
    category: "wireless",
    price: 139,
    shortDesc:
